...
export default function ContactForm(props): JSX.Element {
  ...
  return (
    <div className={` ${cssClass} ${bgColor} ${marginLeft} ${marginRight} ${marginBottom} ${marginTop} ${marginAll} block max-w-sm rounded-lg bg-[#D1F1CB] p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700`}>
      <form>
        {/* <!--Name input-->  */}
        <TEInput
          type="text"
