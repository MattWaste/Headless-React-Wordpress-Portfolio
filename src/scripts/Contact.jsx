...
export default function Contact(){
    ...
    return(
        ...
        <div className="p-1 ml-16 mt-36 contact-container-intro">
            ...
            <div>
            <input name = 'sendCopy' className="mb-6" id='sendCopy' checked={formData.sendCopy} onChange={handleChange} type ='checkbox'></input>
            <label htmlFor="sendCopy"> Send yourself a copy</label>
            <div>
            <button className= " focus:outline-none bg-[#7DDA28] hover:bg-[#5A9D1B] focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 " type="submit">Send Message</button>
            </div>
            </div>
            </form>
