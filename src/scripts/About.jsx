...
export default function About(){
    return(
        ...
        <div className='pt-[12rem] about-container-intro '>
            <p className="text-xl">
            <span className="text-5xl text-green font-staraBold">Matt West</span> is a life-long learner, a maker of digital imprints, and a designer of things. His work in music technology and web/app development have garnered thousands of users since 2015. Recent 
