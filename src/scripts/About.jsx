...
export default function About(){
    return(
        ...
        <div className='about-container-intro py-80 '>
            <p className="text-xl">
            <span className="text-4xl text-green font-staraBold">Matt West</span> is a life-long learner, a maker of digital imprints, and a designer of things. His work in music technology and web/app development have garnered thousands of users since 2015. Recent 
