...
export default function HomePage(){
    ...
    return(
        // <div className="gap-5 pl-14 home-container">
        ...
        <Header></Header>
        <div className="px-24 pt-56 sm:self-center sm:px-6 sm:pt-28 home-container-new grow">
            <div>
            ...
            <div className="pt-8">
                <video className="video-container min-h-[250px] min-w-[250px]" src="http://mawtestsite.local/wp-content/uploads/2023/07/greenportal4.mp4"   autoPlay loop muted width="400px" height="400px" ></video>
            </div>
        </div>
        <Footer></Footer>
        </div>
