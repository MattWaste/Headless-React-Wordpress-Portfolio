...
export default function Footer(props) {
  return (
    <div>
      <footer className="flex py-12 pl-12 text-xs sm:flex-wrap sm:ml-12 pr-36 sm:justify-center sm:gap-4">
        <p className="flex-grow sm:text-center">© 2024 - all rights reserved</p>
        <ul className="flex items-stretch gap-10 sm:self-center">
